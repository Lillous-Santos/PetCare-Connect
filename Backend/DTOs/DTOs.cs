...
// ── Auth ────────────────────────────────────────────────────
public record LoginRequest(string Login, string Senha, string Perfil);
...
public record CriarAvisoRequest(
    string  Titulo,
    string  Texto,
    string  Tipo,      // geral | tutor | pet | consulta
    int?    TutorId,
    int?    PetId
);
...
public record CadastroTutorRequest(string Nome,string Login,string Senha,string? Email,string? Telefone,string? Endereco);
